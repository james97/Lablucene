...
fdfiles = ['/data/Dropbox/workspace/experiment/wt10g/WT10GT451-550.train.quality.2.ipr5level.scaled.f2.r.13.i.45.t.0.007.reg.0.09.run', 
           '/data/Dropbox/workspace/experiment/wt10g/WT10GT451-550.train.quality.2.ipr5level.scaled.f2.run',
            ...
            '/data/Dropbox/workspace/experiment/test_wt10g_train+disk45.quality.1_ndcg_r.7.i.25.t.0.003.reg.0.009.run',
            '/data/Dropbox/workspace/experiment/test_wt10g_train+disk45.quality.2_ndcg_r.3.i.65.t.0.003.reg.0.05.run',
            '/data/Dropbox/workspace/experiment/test_wt10g_train+disk45.quality.1_p15_r.15.i.55.t.0.0001.reg.0.0009.run',
            '/data/Dropbox/workspace/experiment/test_wt10g_train+disk45.quality.2_p15_r.16.i.25.t.0.0005.reg.0.007.run',
...
data_specific_para = {
    ...
    'QueryExpansion.FeedbackfromFile': fdfiles3
    }
}

paradict = {"expansion.documents": [3, 5, 10,15, 20, 30, 50], 
            'expansion.terms': [35], 
            'rocchio.weighted': ['true'], 'rocchio.weighteType': [3],
            'rocchio.exp': [1.5], 
            'rocchio.beta': [0.4, 0.5, 0.6, 0.7, 0.8],
...
paradict = {'QueryExpansion.FeedbackfromFile': ['false'], 
            ...
            "expansion.documents": [3, 5, 10,15, 20, 30, 50],
            'expansion.terms': [35], 'lm.alpha': [0.5],
            'trec.shortFirsPass': ['true']}
